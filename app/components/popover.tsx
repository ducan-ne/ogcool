      ...
      {showArrow && (
        <OverlayArrow className="group">
          <svg
            ...
            height={12}
            viewBox="0 0 12 12"
            className="group-placement-left:-rotate-90 block fill-white stroke-1 stroke-black/10 group-placement-bottom:rotate-180 group-placement-right:rotate-90 dark:fill-[#1f1f21] forced-colors:fill-[Canvas] dark:stroke-zinc-600 forced-colors:stroke-[ButtonBorder]"
          >
