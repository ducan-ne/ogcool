...
export const FileHeader = ({
  ...
  return (
    <div className="flex items-center justify-between bg-gray-200 text-gray-900 text-xs">
      ...
      <Button
        className="mr-2 rounded-md bg-gray-300 p-1 hover:bg-gray-400"
        onPress={() => {
          navigator.clipboard.writeText(content)
          toast("Copied to clipboard")
        }}
      >
        <CopySimple className="h-3 w-3 text-gray-600" />
      </Button>
    </div>
  )
}
